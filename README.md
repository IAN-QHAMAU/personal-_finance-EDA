...
- [personal_finance.html](personal_finance.html) — polished story version for browser viewing and GitHub Pages
...
This README is intended to be the main written report for the project, with the HTML file serving as the hosted presentation layer.
